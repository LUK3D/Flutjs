...
class _App extends Widget {
  ...
  constructor(args: { title?: string; theme?: ThemeData; home: Widget ; classes?:Array<string>}) {
...
function App(args: { title?: string; theme?: ThemeData; home: Widget,width?:number|string, height?:number|string, classes?:Array<string> }) {
